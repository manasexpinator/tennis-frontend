              ...
              <div className="row  mt-5">
                <div className="col-xl-8 col-xxl-8 col-lg-8">
                  ...
                  <p className="fs-6 text-black-50 lh-sm">
                    In2tennis tennis Club is a family orientated club that
                  ...
                  <div className="d-flex mb-5">
                    <Button className="rounded-pill fs-6">
                      Aintree Tennis Club
                    </Button>

                    <Button className="rounded-pill fs-6 ms-3">
                      Greenvale Tennis Club
                    </Button>

                    <Button className="rounded-pill fs-6 ms-3">
                      Merrifield Tennis Club
                    </Button>
                  </div>
                  <div className="book-group d-flex align-items-center">
                    <Button className="rounded-xxxl fs-4">
                      Free Trial Lesson
                    </Button>
                    <Button className="rounded-xxxl ms-5 fs-4">
                      Visit Group
                    </Button>
                ...
                <div className="col-xl-4 col-xxl-4 col-lg-4 xs:ps-4 lg:ps-0">
                  <h4 className="text-black fw-bold">Join Our Group</h4>
