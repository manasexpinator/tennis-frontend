...
import Userpagenew from "./pages/Userpagenew";
    ...
    return (
      <BrowserRouter basename={"/"}>
        <Switch>
          ...
          <Route
            exact
            path={`${process.env.PUBLIC_URL}/shopnew`}
            component={Shopnew}
          />
          <Route
            exact
          ...
          <Route
            exact
            path={`${process.env.PUBLIC_URL}/cartnew`}
            component={CartNew}
          />
          <Route
            exact
          ...
          <Route
            exact
            path={`${process.env.PUBLIC_URL}/checkoutnew`}
          ...
          <Route
            exact
            path={`${process.env.PUBLIC_URL}/userpagenew`}
            //component={Userpagenew}
            render={(props) => <Userpagenew {...props} />}
          />
          <Route
            exact
