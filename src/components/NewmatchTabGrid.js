...
export default function NewmatchTabGrid() {
  return (
    <div>
      <div className="new-match-part mx-auto d-block position-relative">
        <Row className="mt-4 bg-white p-0  rounded">
          <div className="d-flex score-text pt-4">
            <p className="fw-bold fs-3 text-black-50 mb-0">Scores | Details</p>
            <p className="fw-bold fs-3 ms-auto mb-0 text-black-50">
              ...
              <div className="wd-lft d-flex border-right-main ps-3">
                <div className="d-flex align-items-center">
                  ...
                  <div className="ps-3">
                    ...
                    <div className="d-flex">
                      <div className=""></div>
                      <h2 className="text-black fw-bold fs-4">
                        Select Player 2
                      </h2>
                    </div>
                  </div>
