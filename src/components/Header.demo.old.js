        ...
        <nav className={`d-lg-none navigation scroll-bar ${navClass}`}>
          <div className="container ps-0 pe-0">
            <div className="nav-content">
              ...
              <div className="nav-wrap bg-white bg-transparent-card rounded-xxl shadow-xss pt-3 pb-1 mb-2 d-none">
                <div className="nav-caption fw-600 font-xssss text-grey-500">
              ...
              <div className="nav-wrap bg-white bg-transparent-card rounded-xxl shadow-xss pt-3 pb-1 d-none">
                <div className="nav-caption fw-600 font-xssss text-grey-500">
                  <span>Account</span>
                </div>
                <ul className="mb-1">
