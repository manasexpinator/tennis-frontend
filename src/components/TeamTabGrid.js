  ...
  const GroupList = [
    {
      imageUrl: "user.png",
      name: "Aliqa Macale",
      public: "Saturday 7:30am",
      meetup: "Season 2 2022",
      connections: "55.7k",
      follower: "105k",
      following: "71k",
    ...
    <div>
      ...
      <div className="row px-0">
        {GroupList.map((value, index) => (
          <div key={index} className="col-md-4 col-sm-6 pe-2 ps-2 team-col">
            <div
            ...
            >
              ...
              <div className="card-body d-block w-100 p-4 text-center position-relative ">
                ...
                <p className="fw-500 font-xssss text-grey-500 mt-0 mb-3 item-meta">
                  <span class="group-visibility public text-black">
                    {value.public}
                  </span>
                  <span class="group-type bb-current-group-meetups text-black position-static ms-4">
                    {value.meetup}
                  </span>
                </p>
                ...
                <div>
                  <button className="border-0 red-btn text-white rounded-pill px-2 fw-bold mb-2">
                    WRTA
                  </button>
                  <br />
                  <button className="border-0 rounded-pill px-2 fw-bold text-white blue-btn">
                    Aintree Tennis Club
                  </button>
                </div>
